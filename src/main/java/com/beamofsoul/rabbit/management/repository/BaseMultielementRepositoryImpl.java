...
import static com.beamofsoul.rabbit.management.util.QuerydslUtils.doDelete;
import static com.beamofsoul.rabbit.management.util.QuerydslUtils.doUpdate;
import static com.beamofsoul.rabbit.management.util.QuerydslUtils.initQuery;
import static com.beamofsoul.rabbit.management.util.QuerydslUtils.newQuery;
...
public class BaseMultielementRepositoryImpl<T,ID extends Serializable> extends QuerydslJpaRepository<T, ID> implements BaseMultielementRepository<T, ID> {
	...
	public static final String DEFAULT_ENTITY_PRIMARY_KEY = "id";
	...
	public BaseMultielementRepositoryImpl(JpaEntityInformation<T, ID> entityInformation, EntityManager entityManager) {
		...
		this.idPath = entityPath.getNumber(DEFAULT_ENTITY_PRIMARY_KEY, Long.class);
	}
